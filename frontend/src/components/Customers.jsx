            ...
            >
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="relative">
                  ...
                  <img src={`https://ui-avatars.com/api/?name=${selectedCustomer.name}&background=0B1120&color=C084FC&rounded=true&bold=true&size=100`} alt={selectedCustomer.name} className="w-24 h-24 rounded-full border-2 border-amber-400 shadow-[0_0_20px_rgba(192,132,252,0.4)] relative z-10" />
                </div>
                ...
                <div className="text-center w-full">
                  ...
                  <div className="mt-8 space-y-4 bg-[var(--bg-base)]/50 border border-[var(--border-subtle)] p-6 rounded-2xl text-left relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-amber-400 to-emerald-500"></div>
