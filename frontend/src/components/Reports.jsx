      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
               <div className="flex items-center gap-3">
                 <div className="flex -space-x-3">
                   ...
                   <div className="w-10 h-10 rounded-full border-2 border-[var(--bg-base)] bg-[var(--border-subtle)] flex items-center justify-center text-xs font-extrabold text-white relative z-10">+5</div>
                 </div>
        ...
        <div className="flex flex-col gap-8">
          <motion.div whileHover={{ y: -4 }} className="glass-panel border border-[var(--border-subtle)] rounded-3xl p-8 shadow-xl flex flex-col h-full group relative overflow-hidden">
              ...
              <h3 className="text-xl font-extrabold text-white mb-3 relative z-10">Revenue Report</h3>
