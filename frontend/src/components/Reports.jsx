  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24 md:pb-0 px-2 md:px-0">
      ...
      <div className="flex items-center gap-2 mb-6 text-white font-bold text-sm">
         <div className="bg-[#1E293B] p-1.5 rounded-lg border border-[#334155]">
           <RefreshCcw size={16} className="text-cyan-400" />
         </div>
         Recent Report Generation
      </div>

      <div className="bg-[#151C2C] border border-[#1E293B] rounded-2xl overflow-hidden relative">
         <table className="w-full text-left">
            <thead className="bg-[#1E293B]">
               <tr>
                  <th className="px-6 py-4 text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Report Title</th>
                  <th className="px-6 py-4 text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Generated By</th>
                  <th className="px-6 py-4 text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Date</th>
               </tr>
            </thead>
               ...
               <tr className="hover:bg-white/5 transition-colors">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="font-bold text-sm text-white">Fiscal Quarter Review</span>
                    </div>
                  </td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)]">Super Admin (M. Chen)</td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)]">Oct 28, 2023</td>
               </tr>
               <tr className="hover:bg-white/5 transition-colors">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                       <FileText size={16} className="text-cyan-400" />
                       <span className="font-bold text-sm text-white">Monthly Court Occupancy</span>
                    </div>
                  </td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)] flex items-center gap-1.5">
                     <span className="w-1.5 h-1.5 rounded-full bg-cyan-400"></span> System (Automated)
                  </td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)]">Oct 27, 2023</td>
               </tr>
               <tr className="hover:bg-white/5 transition-colors">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                       <FileText size={16} className="text-cyan-400" />
                       <span className="font-bold text-sm text-white">Staff Efficiency Audit</span>
                    </div>
                  </td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)]">Admin (S. Johnson)</td>
                  <td className="px-6 py-5 text-xs text-[var(--text-secondary)]">Oct 25, 2023</td>
               </tr>
            </tbody>
         </table>
      </div>
